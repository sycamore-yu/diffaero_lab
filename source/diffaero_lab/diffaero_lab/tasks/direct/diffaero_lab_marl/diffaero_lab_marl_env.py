...
from .diffaero_lab_marl_env_cfg import DiffaeroLabMarlEnvCfg


class DiffaeroLabMarlEnv(DirectMARLEnv):
    cfg: DiffaeroLabMarlEnvCfg

    def __init__(self, cfg: DiffaeroLabMarlEnvCfg, render_mode: str | None = None, **kwargs):
